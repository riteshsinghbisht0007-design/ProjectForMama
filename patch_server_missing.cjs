  ...
  app.get('/api/notifications', requireAuth, async (req: any, res: any) => {
    ...
    try {
      ...
      for (const summon of summons) {
        ...
        // Normalize time to compare just the dates
...
const insertTarget = "  // Serve Frontend Assets: Vite middleware in Development, static dist/ in Production";

if (code.includes(insertTarget) && !code.includes("/api/notifications")) {
  code = code.replace(insertTarget, notifCode + "\n" + insertTarget);
