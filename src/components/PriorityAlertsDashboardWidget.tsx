        ...
        {priorityNotifications.map(n => {
          ...
          return (
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer hover:bg-card-hover transition-colors flex flex-col justify-between ${
                isOverdue ? 'bg-red-950/20 border-red-800/40' : 
                isToday ? 'bg-amber-950/20 border-amber-800/40' : 
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${
                    isOverdue ? 'bg-red-900/60 text-red-300' :
                    isToday ? 'bg-amber-900/60 text-amber-300' :
