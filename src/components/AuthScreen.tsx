            ...
            <>
              ...
              <div className="space-y-2.5">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl border border-border bg-[#1877F2]/15 hover:bg-[#1877F2]/25 text-xs font-semibold text-primary-text-bright flex items-center justify-center gap-3 transition-colors shadow-sm disabled:opacity-50 cursor-pointer"
                >
